...
public class MyAssembler {
    ...
    public String assembleHeader(String className, List<Pdo> rxPdos, List<Pdo> txPdos, List<Direction> directions) {
        ...
        res += myHeaderAssembler.externAssemble(className, rxPdos, txPdos,directions);
        res += "\n#endif // ETHERCAT_SERVER_CONTROL_" + className + "_H";
        return res;
    }

    public String assembleSource(String className, List<Pdo> rxPdos, List<Pdo> txPdos, List<Direction> directions) {
        ...
        res += mySourceAssembler.entiresAssemble(className, rxPdos, txPdos)
                ...
                + mySourceAssembler.syncAssemble(className, rxPdos, txPdos,directions)
